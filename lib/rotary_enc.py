...
#     # CLK/DT    CLK/DT     CLK/DT    CLK/DT
#     #   00        01         10        11
#     [_R_START, _DIR_CCW, _DIR_CW,  _R_START],             # _R_START
#     [_R_START, _R_START, _DIR_CCW, _DIR_CW ],             # _R_CW_1
#     [_R_START, _DIR_CW,  _DIR_CW,  _DIR_CCW ],             # _R_CW_2
#     [_R_START, _DIR_CCW, _DIR_CW,  _R_START],   # _R_CW_3
#     ]
...
class Rotary:
    ...
    def __init__(self, sw_pin, clk_pin, dt_pin, half_step = True):
    ...
    def value(self):
        ...
        if self._half_step:
            ...
            self._state = _transition_table[self._state & _STATE_MASK][clk_dt_pin]
...
def main():
    ...
    while True:
        ...
        if sw_value != 0:
            print("{:>5} {:>2}".format(counter, rotary_sw._value))
            counter += 1
        sleep_ms(1)
